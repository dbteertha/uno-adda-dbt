const CORE_CACHE='dbt-games-core-v15';
const RUNTIME_CACHE='dbt-games-runtime-v15';
const CACHE_PREFIX='dbt-games-';
const MAX_RUNTIME_ENTRIES=144;
const CORE=[
  ...
  '/flex/privacy.css','/flex/privacy.js','/flex/safety.css','/flex/safety.js',
